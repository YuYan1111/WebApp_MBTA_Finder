...
MAPQUEST_API_KEY = "YhIISZisX9KkxyArk3SnMdFNB5KPTxuZ"
MBTA_API_KEY = "c8d419ce584943ee93a8d64114191dda"
...
def get_json(url):
    ...
    url = f'http://www.mapquestapi.com/geocoding/v1/address?key=YhIISZisX9KkxyArk3SnMdFNB5KPTxuZ&location=Boston%20University'
...
def get_lat_long(place_name):
    ...
    pprint(place_json)
    lat = place_json["results"]["0"]["locations"]["0"]["displayLatLon"]["lat"]# modify this so you get the correct latitude
    lon = place_json["results"]["0"]["locations"]["0"]["displayLatLon"]["lon"] # modify this so you get the correct longitude
...
def get_nearest_station(latitude, longitude):
    ...
    if wheelchair_boarding == 1:
        print('Able for board with wheelchair')
    elif wheelchair_boarding == 2:
        print('Not able to board with wheelchair')
    else:
        print("Erro")
...
def main():
    # final test here
    place = input("Please enter the location address or name:")
